...
var toolbar = renderer.create('<div class=" panel-default"><div class="note-toolbar bg-gray-100 panel-heading"></div></div>');
...
var dialog = renderer.create('<div class="modal" aria-hidden="false" tabindex="-1"/>', function ($node, options) {
    ...
    $node.html([
        ...
        (options.footer
            ? '    <div class="modal-footer"><button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button></div>' : ''),
        '  </div>',
        '</div>'
    ].join(''));
});
...
$$1.extend($$1.summernote.lang, {
    'en-US': {
        ...
        image: {
            ...
            selectFromFiles: '<strong>Usahakan Size Gambar Sekecil Mungkin</strong><br>',
...
var ImageDialog = /** @class */ (function () {
    ...
    ImageDialog.prototype.initialize = function () {
        ...
        var body = [
            ...
            '<br><input class="note-image-input note-form-control note-input" ',
