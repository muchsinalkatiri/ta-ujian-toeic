			...
			<div class="card-body">
				<div class="row">
					...
					<?php if(!empty($soal->nomer_soal) ){ ?> <!-- jika soal belum dimasukan -->
						<?php if($soal->nomer_soal == 101 ){ ?> <!-- untuk soal nomer 1, khusus, pembukaan section reading  -->
							<h3 class="text-center" style=" font-weight: bold; ">Section 2</h3>
							<h1  class="text-center" style=" font-weight: 800; border-bottom: solid 3px; ">Reading Test</h1>
						<?php } ?> <!-- tutup -->
						<?php if(!empty($paket->penjelasan_reading) && $soal->nomer_soal == 101  ){ ?> <!-- penjelasan  -->
							<p class="text-justify mb-3" style="border:1px; border-style:solid; border-color:gray; border-radius: 5px; padding: 3px;"><?php echo $paket->penjelasan_reading; ?></p>
						<?php } ?> <!-- tutup -->
						<?php if($soal->nomer_soal == 101 || $soal->nomer_soal == 141 || $soal->nomer_soal == 153){ ?> <!-- untuk soal pembukaan part  -->
							<h3 style="border-bottom: solid 2px; "><b>Part : <?php echo $part->nama_part; ?></b></h3>
						<?php } ?> <!-- tutup -->

						<?php if($part->directions != "" && ($soal->nomer_soal == 101 || $soal->nomer_soal == 141 || $soal->nomer_soal == 153)){ ?> <!-- jika directions ada -->
						...
						<?php if($part->example != "" && ($soal->nomer_soal == 101 || $soal->nomer_soal == 141 || $soal->nomer_soal == 153)){ ?> <!-- jika example ada -->
							<div class="mb-2" style="border:1px; border-style:solid; border-color:gray; border-radius: 5px; padding: 3px;">
						...
						<?php if($soal->nomer_soal >= 101 && $soal->nomer_soal <= 200){ ?> <!-- untuk soal nomer 1-10  -->
								<ol> 
					...
					<?php }else{ ?> <!-- jika nomer soal kosong -->
						...
						<center>
							<?php if($nomer_soal != 101){ ?>
							<a type="submit"  class="mt-5 btn bg-gray-900 text-gray-100 " href="<?php echo base_url('mahasiswa/ujian/frameujian_reading/'.$id_data_ujian.'4_5'.$prev); ?>">
				              <i class="fa fa-arrow-circle-left"></i> Previous  
	    					</a>
							<?php } ?> <!-- tutup -->
							<?php if($nomer_soal != 200){ ?>
							<a type="submit"  class="mt-5 btn bg-gray-900 text-gray-100 " href="<?php echo base_url('mahasiswa/ujian/frameujian_reading/'.$id_data_ujian.'4_5'.$next); ?>">
				              Next <i class="fa fa-arrow-circle-right"></i> 
	    					</a>
							<?php } ?> <!-- tutup -->
    					</center>
					...
					<div class="col-sm-4">
						<?php 
						$this->load->view('v_mahasiswa/ujian/v_panel_soal2');
						?> 
					</div>
				</div>
		</div>
