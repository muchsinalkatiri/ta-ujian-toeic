...
<div class="row ">
	<div class="col-lg-12">
		<div class="card shadow mb-7">
			...
			<div class="card-body">
				<form class="user" action="<?php echo base_url('admin/admin/create') ?>" method="post" enctype="multipart/form-data">
					<div class="row">
						<div class="col-sm-12" >
						...
						<div class="col-sm-8">
							...
							<div class="form-group row">
								<div class="col-sm-12 mb-3 mb-sm-0">
									<input type="text" class="form-control form-control-user" value="<?php echo set_value('nama'); ?>" id="nama" placeholder="Nama Lengkap" name="nama">
								</div>
							</div>
