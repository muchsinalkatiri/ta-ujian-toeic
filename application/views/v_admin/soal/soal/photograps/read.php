...
<nav>
  <div class="nav nav-tabs" id="nav-tab" role="tablist">
    <a class="nav-item nav-link active" id="nav-soal-tab" data-toggle="tab" href="#nav-soal" role="tab" aria-controls="nav-soal" aria-selected="true">Soal Individu</a>
  ...
  <div class="tab-pane fade show active" id="nav-soal" role="tabpanel" aria-labelledby="nav-soal-tab">
    ...
    <div class="row mb-2  ">
      ...
      <div class="col-lg-2" style="text-align: right;  ">
        <a href="<?php echo base_url(). 'admin/soal/photograps/tambah/'.$paket_dan_part_soal->nama_paket.'4_5'.$paket_dan_part_soal->id_part ?>" class="d-none d-sm-inline-block btn btn-sm bg-gray-900 text-gray-100 shadow-sm" ><i class="fas fa-plus fa-sm text-white-50"></i> Tambah Soal</a>
      </div>
    </div>
