...
<div class="row">
  <div class="col-lg-7">
    <div class="card shadow mb-4">
      ...
      <div class="col-lg-5">
        <img class="card shadow mb-7" id="gambar_nodin"  alt="Preview Gambar" style='width:440px;height:270px; border-radius: 5%;  ' src="<?php echo base_url()."uploads/img-soal/photograps/".$soal->isi_soal?>"> 
      </div>
    </div>
