    ...
    <div class="row mb-2">
      <div class="col-lg-4">
        ...
        <div class="card shadow mb-4">
          ...
          <div class="card-body">
            <form class="user" action="<?php echo base_url('admin/soal/'.$this->uri->segment('3').'/tambah/'.$paket_dan_part_soal->nama_paket.'4_5'.$paket_dan_part_soal->id_part) ?>" method="post" enctype="multipart/form-data">
              <div class="row">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                          <form class="user" action="<?php echo base_url('admin/soal/question_response/tambah_kelompok/'.$paket_dan_part_soal->nama_paket.'4_5'.$paket_dan_part_soal->id_part ) ?>" method="post" enctype="multipart/form-data">
                            <div class="row mb-3">
                                ...
                                <tbody>
                                  <?php foreach ($kelompok_soal as $kelompok ) {
                                    ...
                                    <tr>
                                      ...
                                      <td><center>
                                        <a href="<?php echo base_url(). 'admin/soal/question_response/data_kelompok_soal/'.$paket_dan_part_soal->nama_paket.'4_5'.$paket_dan_part_soal->id_part.'4_5'.$kelompok->id_kelompok_soal ?>" class="d-none d-sm-inline-block btn btn-sm bg-gray-900 text-gray-100 shadow-sm" ><i class="fas fa-plus fa-sm text-white-50"></i> Detail Kelompok Soal</a>
                                        <a href="<?php echo base_url(). 'admin/soal/question_response/edit_kelompok/' . $kelompok->id_kelompok_soal ?>" class="btn btn-primary btn-circle"  ><i class="fa fa-edit"></i></a>
                                    ...
                                    <div class="modal fade"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" id="ModalHapus<?php echo $kelompok->id_kelompok_soal; ?>">
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                                            <a href="<?php echo base_url(). 'admin/soal/question_response/delete_kelompok/' . $kelompok->id_kelompok_soal?>" class="btn btn-danger btn-icon-split">
                                              <span class="icon text-white-50">
                                                <i class="fas fa-trash"></i>
                                              </span>
                                              <span class="text">Delete</span>
