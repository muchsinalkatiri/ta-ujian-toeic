...
<div class="row">
  <div class="col-lg-10">
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        <form class="user" action="<?php echo base_url('admin/soal/'.$this->uri->segment('3').'/edit_kelompok/'.$kelompok->id_kelompok_soal ) ?>" method="post" enctype="multipart/form-data">
          <div class="row mb-3">
