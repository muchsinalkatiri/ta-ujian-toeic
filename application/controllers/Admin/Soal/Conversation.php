...
class Conversation extends CI_Controller {
	...
	{
		$data['page_title'] = 'Data Soal : Conversation';
		// Must login
	...
	public function tambah($nama_paket_id_part=null){
		...
		if ($this->form_validation->run() == FALSE){
			...
			if ($nomer_soal < 41 || $nomer_soal >70) { //cek nomer soal bener ta gak
				$this->session->set_flashdata('nomer_soal_msg','nomer soal harus antara 41-70');    
				if($id_kelompok_soal == 0){redirect('admin/soal/conversation/tambah/'.$nama_paket.'4_5'.$id_part.'4_5'.$id_kelompok_soal);}
				else{redirect('admin/soal/conversation/tambah/'.$nama_paket.'4_5'.$id_part.'4_5'.$id_kelompok_soal);}
			}
				...
				if($check != 0){ //cek nomer soal di paket itu sudah ada apa belum
					...
					if ($insert) {
						...
						if($id_kelompok_soal == 0){redirect('admin/soal/conversation/data_soal/'.$nama_paket.'4_5'.$id_part);}
						else{redirect('admin/soal/conversation/data_kelompok_soal/'.$nama_paket.'4_5'.$id_part.'4_5'.$id_kelompok_soal);}
					}else{
						$this->session->set_flashdata('msg',
	...
	public function tambah_kelompok($nama_paket_id_part=null){
		...
		if ($insert) {
			...
			redirect('admin/soal/conversation/data_soal/'.$nama_paket.'4_5'.$id_part);
		}else{
			$this->session->set_flashdata('msg',
				'<div class="alert alert-danger">
